...
import CoreVoice.Message;
import CoreVoice.SoundPacket;
...
public class ClientConnection extends Thread {
    ...
    private ServerVoice serv; //instance of server, needed to put messages in the server's broadcast queue
    ...
    public ClientConnection(ServerVoice serv, Socket s) {
        this.serv = serv;
        this.s = s;
